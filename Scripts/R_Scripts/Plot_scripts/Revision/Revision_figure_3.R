...
ggsave("./Plots/Revision_plots/Figure3/Fig3A_total_v_med.pdf", pltA, width = 6, height = 4, units = "cm")
...
ggsave("./Plots/Revision_plots/Figure3/Fig3B_effect_size_enrich_dir.pdf", pltB, width = 6, height = 4, units = "cm")
...
ggsave("./Plots/Revision_plots/Figure3/Fig3C_effect_size_dist_dir.pdf", pltC, width = 6, height = 4, units = "cm")
...
ggsave("./Plots/Revision_plots/Figure3/Fig3D_TFBS_pos_dir.pdf", pltD, width = 6, height = 4, units = "cm")
...
ggsave("./Plots/Revision_plots/Figure3/Fig3E_Age_v_CD4EMRA.pdf", pltE, width = 6, height = 4, units = "cm")
...
ggsave("./Plots/Revision_plots/Figure3/Fig3F_disp_bar_plot.pdf", pltF, width = 6, height = 4, units = "cm")
...
ggsave("./Plots/Revision_plots/Figure3/Fig3G_ewas_v_disp.pdf", pltI, width = 6, height = 4, units = "cm")
...
ggsave("./Plots/Revision_plots/Figure3/Fig3H_med_state_enrich.pdf", pltI, width = 6, height = 4, units = "cm")
...
ggsave("./Plots/Revision_plots/Figure3/Fig3I_med_dist.pdf", pltI, width = 6, height = 4, units = "cm")
...
ggsave("./Plots/Revision_plots/Figure3/Fig3I_med_TFBS_enrich.pdf", pltI, width = 6, height = 4, units = "cm")
...
ggsave("./Plots/Revision_plots/Figure3/Figure_3.png", plt, width = 172, height = 147, units = "mm", dpi = 500)
ggsave("./Plots/Revision_plots/Figure3/Figure_3.pdf", plt, width = 172, height = 147, units = "mm")
