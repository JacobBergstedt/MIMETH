...
mf <- covs %>%
  ...
  mutate(Myeloid = X_mono_of_total.panel5 + X_PMN_of_total.panel5,
...
ggsave("./Plots/Revision2_plots/Figure4/Fig4A_local_meQTL_CpG_chromatin_state_enrichments.pdf", pltA, width = 6, height = 4, units = "cm")
...
ggsave("./Plots/Revision2_plots/Figure4/Fig4B_remote_meQTL_CpG_chromatin_state_enrichments.pdf", pltB, width = 6, height = 4, units = "cm")
...
ggsave("./Plots/Revision2_plots/Figure4/Fig4C_remote_meQTL_SNP_chromatin_state_enrichments.pdf", pltC, width = 6, height = 4, units = "cm")
...
ggsave("./Plots/Revision2_plots/Figure4/Fig4D_interaction_p_values.pdf", pltD, width = 6, height = 6, units = "cm")
...
ggsave("./Plots/Revision2_plots/Figure4/Fig4E_BACE2.pdf", pltE, width = 6, height = 6, units = "cm")
...
pltF <- plt_frame %>% 
  ggplot(aes(x = Myeloid, y = CpG, color = Genotype)) +
  geom_point(size = point_size_scatter) +
  geom_smooth(method = "lm", se = FALSE, size = line_size_scatter) +
...
ggsave("./Plots/Revision2_plots/Figure4/Fig4F_CLEC4C.pdf", pltF, width = 6, height = 6, units = "cm")
...
ggsave("./Plots/Revision2_plots/Figure4/Figure_4.png", plt, width = 172, height = 172, units = "mm", dpi = 500)
ggsave("./Plots/Revision2_plots/Figure4/Figure_4.pdf", plt, width = 172, height = 172, units = "mm")
