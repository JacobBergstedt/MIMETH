...
cell_lines_sub <- cell_lines[c(9, 12, 1, 4, 8, 6, 10, 11)]
...
saveRDS(chromatin_state_enrichments, "./Data/RData/Results/MeQTL/meQTL_chromatin_state_enrichments.rds")
saveRDS(geography_enrichments, "./Data/RData/Results/MeQTL/meQTL_geography_enrichments.rds")
...
ggsave("./Plots/Odds_ratios/Roadmap/trans_snps_meqtl.pdf", plt, width = 20, height = 10, units = "cm")
...
plt <- enrichments_trans_probes %>%
  ...
  theme(strip.background = element_rect(fill = "white")) +
  facet_wrap(vars(Cell), nrow = 1)
ggsave("./Plots/Odds_ratios/Roadmap/trans_probes_meqtl.pdf", plt, width = 20, height = 10, units = "cm")
...
plt <- enrichments_cis_probes %>%
  ...
  theme(strip.background = element_rect(fill = "white")) +
  facet_wrap(vars(Cell), nrow = 1)
ggsave("./Plots/Odds_ratios/Roadmap/cis_meqtl.pdf", plt, width = 20, height = 10, units = "cm")
...
ggsave("./Plots/Odds_ratios/Roadmap/Cis_meQTL/CD8_naive.pdf", plt, width = 4, height = 4, units = "cm")
...
ggsave("./Plots/Odds_ratios/Roadmap/Cis_meQTL/CD4_naive.pdf", plt, width = 4, height = 4, units = "cm")
...
ggsave("./Plots/Odds_ratios/Roadmap/Trans_meQTL/Probes/CD4_naive.pdf", plt, width = 4, height = 4, units = "cm")
...
ggsave("./Plots/Odds_ratios/Roadmap/Trans_meQTL/SNPs/CD4_naive.pdf", plt, width = 4, height = 4, units = "cm")
...
ggsave("./Plots/Odds_ratios/Roadmap/Trans_meQTL/Probes/CD8_naive.pdf", plt, width = 4, height = 4, units = "cm")
...
ggsave("./Plots/Odds_ratios/Roadmap/Trans_meQTL/SNPs/CD8_naive.pdf", plt, width = 4, height = 4, units = "cm")
