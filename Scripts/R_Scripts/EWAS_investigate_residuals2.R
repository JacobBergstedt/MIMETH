...
plt <- res %>%
  ggplot(aes(x = Residuals, y = ..count..)) +
...
ggsave("./tmp.pdf", plt, width = 20, height = 20, units = "cm")
...
ggsave("./tmp2.pdf", plt, width = 20, height = 20, units = "cm")
...
ggsave("./tmp3.pdf", plt, width = 20, height = 20, units = "cm")
...
ggsave("./tmp4.pdf", plt, width = 20, height = 20, units = "cm")
